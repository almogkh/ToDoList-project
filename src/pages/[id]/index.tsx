...
function ListItem(props: { task: Task, id: string, index: number, editMobile: (a: string, b: Date, callback: (a: string, b: Date) => void) => void }) {
  ...
  return (
    <tr>
      ...
      <td className="space-x-1 md:space-x-6">
        ...
        <button
          className="dark:text-white lg:border border-black dark:border-white rounded-md lg:bg-red-500 lg:hover:bg-red-600 lg:dark:bg-red-900 lg:dark:hover:bg-red-950"
          onClick={() => {
